        ...
        <div>
          {standings.map((row, i) => {
            ...
            return (
              <div
                key={row.teamId}
                className={`px-4 py-3 flex items-center gap-3 border-b border-stone-50 last:border-0 ${isLeader ? 'bg-[#FDF6F0]' : 'bg-white'}`}
              >
        ...
        <div>
          {standings.map((row, i) => {
            ...
            return (
              <div
                key={row.teamId}
                className={`px-4 py-2.5 flex items-center gap-3 border-b border-[#F7C6D0]/50 last:border-0
